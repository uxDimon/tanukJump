<template>
    <div class="pop-up__item_message">
        <tanuki-message
            ...
            :message="`Привет, ${userName}! Прыгай<br> как можно выше, чтобы показать,<br> как ты болеешь за наших спортсменов!<br> Для этого тебе нужно вовремя нажимать<br>кнопку прыжка. Готов?<br>Тогда жми «СТАРТ!»`"
            :face="1"
        ></tanuki-message>
